    ...
    return Scaffold(
      bottomNavigationBar: Obx(() => BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: ImageIcon(AssetImage("assets/icons/favorite.png"),), label: 'Favorites'.tr),
          BottomNavigationBarItem(icon: ImageIcon(AssetImage("assets/icons/cart.png")), label: 'Cart'.tr),
          BottomNavigationBarItem(
              icon: ImageIcon(
